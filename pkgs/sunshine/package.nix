...
stdenv'.mkDerivation (finalAttrs: {
  pname = "sunshine";
  version = "2026.118.193732-7034c84";

  src = fetchFromGitHub {
    owner = "LizardByte";
    repo = "Sunshine";
    rev = "7034c84a4617a31311d44282db4be13aa0513b47";
    hash = "sha256-vxUZo4yc/0mtNuNL/v0GExCItvFOWCmS2vd5NEJXRJo=";
  ...
  ui = buildNpmPackage {
    ...
    pname = "sunshine-ui";
    npmDepsHash = "sha256-hKHJDRuh6JfMMAHX4BAJs80LX2Hk9Q/gJY40+rLW4LY=";
  ...
  env = {
    ...
    BRANCH = "feat/linux/add-xdg-portal-grab";
    COMMIT = "7034c84a4617a31311d44282db4be13aa0513b47";
  };
